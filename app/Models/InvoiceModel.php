...
class InvoiceModel extends Model
{
	...
	public function ambil_data($juragan = NULL)
	{
		...
		$inv->select('CONCAT("[" ,GROUP_CONCAT(DISTINCT CONCAT("{","\"id\":",x.id_pembayaran,",","\"tipe\":",x.tipe_pembayaran,",","\"sumber\":",x.sumber_dana,",","\"nominal\":",x.total_pembayaran,",","\"status\":",x.status,",","\"tanggal_bayar\":",x.tanggal_pembayaran,",","\"tanggal_cek\":","\"",IFNULL(x.tanggal_cek, "null"),"\"}")),"]") as pembayaran');
	...
	{
		$builder = $this->db->table('invoice f');
