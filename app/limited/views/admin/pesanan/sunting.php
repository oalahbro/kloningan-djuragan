...
<div class="" id="">
	...
	<div class="container-fluid navigasi">
		<ul class="nav nav-tabs">
			<li role="presentation"><?php echo anchor('admin/pesanan/lihat/' . $juragan . '/all', 'Semua'); ?></li>
			<li role="presentation"><?php echo anchor('admin/pesanan/lihat/' . $juragan . '/pending', 'Pending'); ?></li>
			<li role="presentation"><?php echo anchor('admin/pesanan/lihat/' . $juragan . '/terkirim', 'Terkirim'); ?></li>
			<li role="presentation" class="active"><?php echo anchor('', 'Sunting'); ?></li>
		</ul>
	</div>
				...
				<div class="col-sm-10 col-sm-offset-1">
					<div class="well">
						<div class="panel panel-danger">
							...
							$hide = array(
								'image' => json_encode((isset($detail->i) ? $detail->i : array() ))
								);

							echo form_open('admin/pesanan/sunting?id=' . save_url_encode($pesanan->slug) , $attr, $hide);
							?>
							<div class="panel-body">  
								...
								$j = $this->juragan->_semua();
								$o_juragan = array();

								$o_juragan[''] = 'Pilih Juragan';
								foreach ($j->result() as $key) {
									$o_juragan[$key->id] = $key->nama;
								}

								echo '<div class="form-group juragan_field">';
									echo form_label('Juragan', 'juragan');
									echo '<div class="row">';
										echo '<div class="col-sm-4">';
											echo form_dropdown('juragan', $o_juragan, set_value('juragan', $pesanan->juragan), array('class' => 'form-control', 'required' => 'required'));
										echo '</div>';
									echo '</div>';
								echo '</div>'; // end .form-group.juragan_field

								echo '<div class="form-group nama_field">';
									echo form_label('Nama', 'nama');
									echo '<div class="row">';
										echo '<div class="col-sm-4">';
											echo form_input($form_nama, set_value('nama', $pemesan->n));
										echo '</div>';
									echo '</div>';
								...
								echo '<div class="form-group hp_fields">';
									...
									echo '<div class="row">';
										echo '<div class="col-sm-3" id="cloneHP">';
											echo form_input($form_hp, set_value('hp[0]', $pemesan->p[0]));
										echo '</div>';

										$displayA = 'inline-block';
										$displayR = 'none';
										if(count(set_value('hp[]', $pemesan->p)) > 1) {
											echo '<div class="col-sm-3 isihp">';
												echo form_input($form_hp, set_value('hp[1]', $pemesan->p[1]));
											echo '</div>';
											$displayA = 'none';
								...
								echo '<div class="form-group alamat_field">';
									...
									echo '<div class="row">';
										echo '<div class="col-sm-8">';
											echo form_textarea($form_alamat,set_value('alamat', $pemesan->a));
										echo '</div>';
									echo '</div>';
								...
								echo '<div>';
									echo '<div class="form-group" id="ngok">';
										...
										echo '<div class="row clonedInput berijarakbawah kalkulasi" data-pesanan-index="0" id="entry1">';
											...
											echo '<div class="col-sm-3">';
												echo '<div class="input-group"><span class="input-group-addon">Kode</span>';
													echo form_input($form_kode, set_value('kode[0]', $prod[0]->c));
												echo '</div>';
											echo '</div>';
											...
											echo '<div class="col-sm-3">';
												echo '<div class="input-group"><span class="input-group-addon">Harga @</span>';
													echo form_input($form_harga_a, set_value('harga_a[0]', (isset($prod[0]->h) ? $prod[0]->h : 0 )));
												echo '</div>';
											echo '</div>';
											...
											echo '<div class="col-sm-3">';
												echo '<div class="input-group"><span class="input-group-addon">Ukuran</span>';
													echo form_dropdown('size[]', $options, set_value('size[0]', $prod[0]->s), array('class' => 'form-control', 'required' => 'required' ));
												echo '</div>';
											echo '</div>';
											...
											echo '<div class="col-sm-2">';
												echo '<div class="input-group"><span class="input-group-addon">Jumlah</span>';
													echo form_input($form_jumlah, set_value('jumlah[0]', $prod[0]->q ));
												echo '</div>';
											echo '</div>';
										...
										for ($i=1; $i < count(set_value('kode[]', $prod, FALSE )); $i++) { 
											echo '<div class="row berijarakbawah" data-pesanan-index="'.$i.'">';
											
												// kode
												echo '<div class="col-sm-3">';
													echo '<div class="input-group"><span class="input-group-addon">Kode</span>';
														echo form_input($form_kode, set_value('kode['.$i.']', $prod[$i]->c));
													echo '</div>';
												echo '</div>';
												...
												echo '<div class="col-sm-3">';
													echo '<div class="input-group"><span class="input-group-addon">Harga @</span>';
														echo form_input($form_harga_a, set_value('harga_a['.$i.']', (isset($prod[$i]->h) ? $prod[$i]->h : 0 ) ));
													echo '</div>';
												echo '</div>';
												...
												echo '<div class="col-sm-3">';
													echo '<div class="input-group"><span class="input-group-addon">Ukuran</span>';
														...
														echo form_dropdown('size[]', $options, set_value('size['.$i.']', $prod[$i]->s), array('class' => 'form-control', 'required' => 'required'));
													echo '</div>';
												echo '</div>';
												...
												echo '<div class="col-sm-2">';
													echo '<div class="input-group"><span class="input-group-addon">Jumlah</span>';
														echo form_input($form_jumlah, set_value('jumlah['.$i.']', $prod[$i]->q));
													echo '</div>';
												echo '</div>';
								...
								echo '<div class="row" id="status_f">';
										...
										echo '<div class="form-group">';
											echo '<div class="form-check">';
												echo '<label class="form-check-label">';
													echo form_radio('status_transfer', 'lunas', set_radio('status_transfer', 'lunas', ($biaya->s === 'lunas' ? TRUE : FALSE)));
											...
											echo '<div class="form-check">';
												echo '<label class="form-check-label">';
													echo form_radio('status_transfer', 'dp', set_radio('status_transfer', 'dp', ($biaya->s === 'dp' ? TRUE : FALSE) ));
									...
									echo '<div class="col-sm-3">';
										echo '<div class="form-group" id="bank">';
											...
											echo form_input($form_bank, set_value('bank', $biaya->b));
										echo '</div>';
									echo '</div>';
								echo '</div>';
									...
									echo '<div class="col-sm-4">';
										echo '<div class="form-group">';
											...
											echo '<div class="input-group">';
												...
												echo form_input($form_harga, set_value('harga', $biaya->m->h));
											echo '</div>';
										echo '</div>';
										...
										echo '<div class="form-group ">';
											...
											echo '<div class="input-group">';
												...
												echo form_input($form_ongkir, set_value('ongkir', (isset($biaya->m->o)? $biaya->m->o: 0) ));
											echo '</div>';
										echo '</div>';
										...
										echo '<div class="form-group ">';
											...
											echo '<div class="input-group">';
												...
												echo form_input($form_transfer, set_value('transfer', $biaya->m->t ));
											echo '</div>';
										echo '</div>';
									echo '</div>';
									...
									echo '<div class="col-sm-4">';
										echo '<div class="form-group">';
											...
											echo '<div class="input-group">';
												...
												echo form_input($form_diskon, set_value('diskon', (isset($biaya->m->d)? $biaya->m->d: 0) ));
											echo '</div>';
										echo '</div>';
										...
										echo '<div class="form-group">';
											...
											echo '<div class="input-group">';
												...
												echo form_input($form_unik, set_value('unik', (isset($biaya->m->u)? $biaya->m->u: 0)));
											echo '</div>';
										echo '</div>';
									echo '</div>';
								echo '</div>';
								...
								echo '<div class="form-group ">';
									...
									echo '<div class="row">';
										echo '<div class="col-sm-8">';
											echo form_textarea($form_keterangan,set_value('keterangan', (isset($detail->n)? $detail->n: '')));
										echo '</div>';
									echo '</div>';
								echo '</div>';
								?>
								...
								<div class="form-group">
									...
									<table class="table table-hover">
										<tbody id="result">
											...
											if(isset($detail->i)) {
												$i = 1;
												foreach ($detail->i as $g) {

													echo '<tr><td>'.anchor($g, 'Gambar ' . $i).'</td></tr>';
													$i++;
												}
											}
											?>
...
echo '<div class="col-sm-3">';
echo '<div class="input-group"><span class="input-group-addon">Ukuran</span>';
echo form_dropdown('size[]', $options, '', array('class' => 'form-control', 'required' => 'required'));
echo '</div>';
echo '</div>';
