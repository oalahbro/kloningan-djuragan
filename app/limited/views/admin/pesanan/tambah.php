						...
						<div class="panel panel-danger">
							...
							<div class="panel-body">  
								...
								$form_dp = array(
									'name' => 'dp',
									'id' => 'dp',
									'class' => 'form-control dp calc',
									'placeholder' => '20000',
									'required' => 'required',
									'pattern' => '^(?:[1-9]\d*|0)$'
									);

								// form field tarif pelunasan
								$form_pelunasan = array(
									'name' => 'pelunasan',
									'id' => 'pelunasan',
									'class' => 'form-control pelunasan calc',
									'placeholder' => '20000',
									'required' => 'required',
									'pattern' => '^(?:[1-9]\d*|0)$'
									);
								...
								echo '<div class="form-group juragan_field">';
									...
									echo '<div class="row">';
										echo '<div class="col-sm-4">';
											echo form_dropdown('juragan', $o_juragan, set_value('juragan', $id_juragan), array('class' => 'form-control', 'required' => 'required'));
										echo '</div>';
									echo '</div>';
										...
										echo '<div class="row clonedInput berijarakbawah kalkulasi" data-pesanan-index="0" id="entry1">';
											...
											echo '<div class="col-sm-3">';
												echo '<div class="input-group"><span class="input-group-addon">Ukuran</span>';
													echo form_dropdown('size[]', $options, set_value('size[0]'), array('class' => 'form-control', 'required' => 'required' ));
												echo '</div>';
											echo '</div>';
											...
											echo '<div class="row berijarakbawah" data-pesanan-index="'.$i.'">';
												...
												echo '<div class="col-sm-3">';
													echo '<div class="input-group"><span class="input-group-addon">Ukuran</span>';
														...
														echo form_dropdown('size[]', $options, set_value('size['.$i.']'), array('class' => 'form-control', 'required' => 'required' ));
													echo '</div>';
												echo '</div>';
										...
										echo '<div class="form-group">';
											echo '<div class="form-check">';
												echo '<label class="form-check-label">';
													echo form_radio('status_transfer', 'lunas', set_radio('status_transfer', 'lunas', TRUE));
											...
											echo '<div class="form-check">';
												echo '<label class="form-check-label">';
													echo form_radio('status_transfer', 'dp', set_radio('status_transfer', 'dp'), array('id' => 'dp_ch'));
													echo '<span class="label label-warning">DP</span> <em>--Down Payment--</em>';
												echo '</label>';
											echo '</div>';
										echo '</div>';
									echo '</div>';
