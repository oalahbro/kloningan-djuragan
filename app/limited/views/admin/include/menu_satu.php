...
<div class="content-head">
	...
	if(empty($url) || $url === 'index' || $url === 'tambah' || $url === 'tambah_member' || $url === 'edit_pesanan') {
	?>
			...
			<div class="">
				<ul class="nav nav-pills">
					...
					<li role="presentation"<?php if($halaman === 'tambah') { echo ' class="active"';}?>><?php echo anchor('administrator/tambah/' . $jur, '<i class="glyphicon glyphicon-pencil"></i> Tambah'); ?></li>
						<?php if($tambah_member > 0) { ?>
						<li role="presentation"<?php if($url === 'tambah_member') { echo ' class="active"';}?>><?php echo anchor('administrator/tambah_member/' . $jur, '<i class="glyphicon glyphicon-pencil"></i> Tambah Pesanan Member'); ?></li>
						<?php } ?>
					<?php } ?>
