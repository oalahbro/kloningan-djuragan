...
<div class="" id="">
	...
	<div class="container-fluid navigasi">
		<ul class="nav nav-tabs">
			<li role="presentation"><?php echo anchor('/pesanan/all', 'Semua'); ?></li>
			<li role="presentation"><?php echo anchor('/pesanan/pending', 'Pending'); ?></li>
			<li role="presentation"><?php echo anchor('/pesanan/terkirim', 'Terkirim'); ?></li>
