...
<div class="" id="utamaOrder">
	...
	<div class="container-fluid navigasi">
		<ul class="nav nav-tabs">
			<li role="presentation" class="<?php echo ($status === 'all' ? 'active':''); ?>"><?php echo anchor( '/pesanan/all', 'Semua'); ?></li>
			<li role="presentation" class="<?php echo ($status === 'pending' ? 'active':''); ?>"><?php echo anchor( '/pesanan/pending', 'Pending'); ?></li>
			<li role="presentation" class="<?php echo ($status ==='terkirim' ? 'active':''); ?>"><?php echo anchor( '/pesanan/terkirim', 'Terkirim'); ?></li>
		</ul>
	</div>
							...
							foreach ($q->result() as $key) {
								...
								if($key->status_transfer === 'ada' && $key->status_kirim === 'pending') {
									...
									if($id_submitted === $key->oleh) {
										$button_sunting = '<li>' . anchor('pesanan/sunting?id=' . $slug_edit, 'Sunting'). '</li>';
									}

									if($id_submitted === $key->oleh) {
										$button_remove = '<li>' . anchor('pesanan/hapus?id=' . $slug_edit, 'Hapus'). '</li>';
									}
