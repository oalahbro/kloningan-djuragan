				...
				<div class="col-sm-10 col-sm-offset-1">
					<div class="well">
						<div class="panel panel-danger">
							...
							echo form_open(current_url() . '?id=' . save_url_encode($pesanan->id_pesanan) , $attr, $hide);
							?>
										...
										echo '<div class="form-group">';
											echo '<div class="form-check">';
												echo '<label class="form-check-label">';
													echo form_radio('status_transfer', 'lunas', NULL, set_radio('status_transfer', 'lunas', ($biaya->s === 'lunas' ? TRUE : FALSE)));
											...
											echo '<div class="form-check">';
												echo '<label class="form-check-label">';
													echo form_radio('status_transfer', 'dp', NULL, set_radio('status_transfer', 'dp', ($biaya->s === 'dp' ? TRUE : FALSE) ));
