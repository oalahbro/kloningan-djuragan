...
$(function () {
    ...
    $('#sidebar').on('show.bs.collapse', function () {
        ...
        $.getJSON("<?php echo site_url('juragan/ambil'); ?>").done(function( response ) {
            ...
            $('#listLi').append(
<<<<<<< HEAD
                $('<li>', {html: '<a href="<?php echo site_url("a/faktur/lihat/s_juragan") ?>"><i class="fas fa-users"></i> Semua Juragan</a>'})
            );
            $.each(response.data, function(index, element) {
                $('#listLi').append(
                    $('<li>', {html: '<a href="<?php echo site_url("a/faktur/lihat/") ?>'+element.slug+'"><i class="fas fa-user-circle"></i> '+element.nama+'</a>'})
=======
