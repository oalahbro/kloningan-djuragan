...
class Faktur extends BaseController
{
	...
	public function sunting($id)
	{
		...
		$rowid = $this->faktur->get($juragan = NULL, $id)->getResult();
		if ($rowid !== NULL) {
			...
			$data = [
				'title' => 'Sunting Faktur',
				'pesanan' => $rowid[0]
			];
			echo view(base_user() . '/faktur/sunting', $data);
		}
	}

	public function suntings($seri_faktur) {
		$diijinkan = FAlSE;
	...
	public function ab()
	{
		...
		$text = save_url_encode('128718898798');
		var_dump($text);

		var_dump(save_url_decode($text));
