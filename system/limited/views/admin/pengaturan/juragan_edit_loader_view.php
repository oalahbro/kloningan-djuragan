		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="form-group">
					...
					<?php echo form_input(array('name' => 'short', 'value' => $row->short , 'id' => 'short', 'class' => 'form-control', 'placeholder' => 'misal - FC', 'maxlength' => '2')) ?>
				</div>
				<div class="form-group">
				...
				<div class="checkbox">
					<label>
						<input type="checkbox" name="membership" value="aktif"<?php if($row->membership === '1'){ ?> checked="checked"<?php } ?>>
