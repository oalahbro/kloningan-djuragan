            ...
            <div class="panel panel-danger">
              ...
              <div class="panel-body">
                ...
                <div class="form-group" id="type">
                  ...
                  <div class="row multiple-form-group entry" id="entry"> <!-- data-max="3" -->
                    <div class="col-sm-4">
                    ...
                    <div class="col-sm-3">
                      <div class="input-group <?php // if( ! empty(form_error('jumlah[]'))) {echo 'has-error';} ?>">
                       ...
                       <?php echo form_input(array('value' => set_value('jumlah[]'), 'class' => 'form-control', 'required' => '', 'name' => 'jumlah[]', 'placeholder' => 'jumlah', 'type' => 'number', 'min' => '1')) ?>
                     </div>
                   </div> <!-- /jumlah -->
                   <div class="col-sm-1">
                     <button class="btn btn-success btn-add btn-block" type="button">
