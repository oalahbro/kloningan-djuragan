              ...
              if ($pesanan->num_rows() > 0)
              {
                ...
                <div class="panel-body">
                  ...
                  <div class="form-group <?php // if( ! empty(form_error('hp'))) {echo 'has-error';} ?>">
                    ...
                    <div class="row">
                      <div class="col-sm-3">
                        <?php echo form_input(array('value' => $row->hp, 'name' => 'hp', 'id' => 'hp', 'class' => 'form-control', 'required' => '', 'placeholder' => '08xxxxxxxxxx', 'maxlength' => '14', 'minlength' => '10')); ?>
                      </div>
                    </div>
                  </div>
                      ...
                      <div id="entry" class="row entry multiple-form-group">
                        <div class="col-sm-4">
                          <div class="input-group <?php // if( ! empty(form_error('kode[]'))) {echo 'has-error';} ?>">
                            ...
                            <?php echo form_input(array('value' => strtoupper($data[0]),'class' => 'form-control kode','autocomplete' => 'off', 'required' => '', 'name' => 'kode[]', 'placeholder' => 'kode produk')) ?>
                          </div>
                        </div>
                        <div class="col-sm-4">
                        ...
                        <div class="col-sm-3">
                          <div class="input-group <?php // if( ! empty(form_error('jumlah[]'))) {echo 'has-error';} ?>">
                            ...
                            <?php echo form_input(array('value' => strtoupper($data[2]), 'class' => 'form-control', 'required' => '', 'name' => 'jumlah[]', 'placeholder' => '1', 'min' => '1', 'type'=> 'number')) ?>
                          </div>
                        </div>
                        <div class="col-sm-1">
                          <div class="input-group">
                            ...
                            <span class="input-group-btn">
                              <button class="btn btn-danger btn-block btn-remove" type="button">
