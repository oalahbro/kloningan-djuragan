...
<body>
	...
	<div id="container">
		<div class="tengahkan">
			<div class="formlogin">
				<h2 class="text-xs-center h2"><?php echo strtoupper($this->config->item('site_name')); ?></h2>
				<div class="well">
					<?php echo form_open(''); ?>
					...
					<?php echo form_close(); ?>
					<small class="text-muted font-italic">rendered in <strong>{elapsed_time}</strong> seconds</small>
				</div>			
			</div>
		</div>
	</div>
